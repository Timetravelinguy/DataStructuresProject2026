...
- `include/datastructures/`: Public headers for each data structure.
- `src/datastructures/`: Source stubs paired with headers.
- `src/main.cpp`: Main entry point for manual experiments.
